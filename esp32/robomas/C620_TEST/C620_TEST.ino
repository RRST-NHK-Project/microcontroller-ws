...
//------設定値-----//
int target_angle = 90.0; //目標角度
int target_rpm[NUMMOTOR] = {0}; //目標rpm
...
void CAN_Task(void *pvParameters) {
  ...
  int packetSize = CAN.parsePacket();
   ...
   vel_out[i] = pid_vel(target_rpm[i], vel_input[i], vel_error_prev[i], vel_prop_prev[i],vel_output[i], kp_vel, ki_vel, kd_vel, dt);
