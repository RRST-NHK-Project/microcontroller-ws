...
int encoders[NUM_MOTORS] = {0};
int rpms[NUM_MOTORS] = {0};
int currents[NUM_MOTORS] = {0};

bool offset_ok[NUM_MOTORS] = {false};
int encoder_offset[NUM_MOTORS] = {0};
int last_encoder[NUM_MOTORS];
int rotation_count[NUM_MOTORS] = {0};
long total_encoder[NUM_MOTORS] = {0};
